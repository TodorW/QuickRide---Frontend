...
const ConfirmReservation = ({ open, setOpen }) => {
  ...
  return (
    ...
    >
      <DialogBackdrop
        transition
        className="fixed inset-0 hidden bg-gray-500 bg-opacity-75 dark:bg-black dark:bg-opacity-75 transition-opacity data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in md:block"
      />
          ...
          >
            <div className="relative flex w-full items-center overflow-hidden bg-white dark:bg-gray-800 px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8">
              ...
              <div className="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                <div className="aspect-h-3 aspect-w-2 overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-700 sm:col-span-4 lg:col-span-5">
                  <img
                    alt={`Car image`}
                  ...
                  <section aria-labelledby="options-heading" className="mt-10">
                    ...
                    <div className="mb-4">
                      ...
                      <DatePicker
                        ...
                        className="block w-full px-4 py-2 bg-gray-300 border border-gray-300 rounded-md text-gray-900"
